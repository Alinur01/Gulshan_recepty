...
const HeaderList = ({burger, user}) => {
    ...
    return (
        <ul  className={`header__list ${burger ? 'header__list_active' : ''}`}>
            ...
            <li onClick={() => setIsActive(!isActive)} className='header__nav-items' >Мужчинам <button className='header__nav-arrow' onClick={() => setIsActive(!isActive)}>
                {
            ...
            <li onClick={() => setIsActive3(!isActive3)} className='header__nav-items'>Для дома <button className='header__nav-arrow' onClick={() => setIsActive3(!isActive3)}>
                {
...

                {
                    isActive3 && <ul className='header__nav-lists'>
                        ...
                        <li className='header__nav-itm'><Link className='header__nav-itm' to='catalog/hoody' onClick={() => dispatch(changeStatus('woman'))}>Для Кухни</Link></li>
                        <li className='header__nav-itm'><Link className='header__nav-itm' to='catalog/sweatshirt' onClick={() => dispatch(changeStatus('woman'))}>Для спальни</Link></li>
                        <li className='header__nav-itm'><Link className='header__nav-itm' to='catalog/pants' onClick={() => dispatch(changeStatus('woman'))}>Для ванной</Link></li>
                        <li className='header__nav-itm'><Link className='header__nav-itm' to='catalog/jacket' onClick={() => dispatch(changeStatus('woman'))}>Для огрода</Link></li>
                    </ul>
                }
            </li>
            <li onClick={() => setIsActive2(!isActive2)} className='header__nav-items'>Женщинам <button className='header__nav-arrow' onClick={() => setIsActive2(!isActive2)}>
                {
